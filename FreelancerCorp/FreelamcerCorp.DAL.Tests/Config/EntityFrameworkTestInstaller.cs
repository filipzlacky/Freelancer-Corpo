...
namespace FreelamcerCorp.DAL.Tests.Config
{
    class EntityFrameworkTestInstaller : IWindsorInstaller
    {
        ...
        private static DbContext InitializeDatabase()
        {
            ...
            context.Corporations.RemoveRange(context.Corporations);
            ...
            context.Freelancers.Add(new Freelancer(Sex.TRANSGENDER, new DateTime(1997, 5, 15), "Liberec", "sunshine33@azet.cz", "Simon Sarafy", "nemam problem"));

            context.Corporations.Add(new Corporation("Úzka 12, Zvolen 925 25", "greatcorp@gmail.com", "GreatCorp", "berieme kazdeho"));
            context.Corporations.Add(new Corporation("Adresna 0, Niekde 999 99", "nekontaktuj@vaznenie.com", "NejakyCorp", "nechod sem"));
            context.Corporations.Add(new Corporation("Adresna 0, Niekde 999 99", "uzzasevy@nieee.com", "NoCorp", "navzdy zatvorene"));
